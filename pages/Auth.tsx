          ...
          <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 lg:w2/5 lg:max-w-md rounded-md w-full">
            ...
            <div className="flex flex-row items-center gap-4 mt-8 justify-center">
              <div
                ...
                className="w-10 h-10 bg-white rounded-full flex items-center justify-center cursor-pointer hover:opacity-80 transiton"
              >
                <FcGoogle size={30} />
              </div>
              <div
            ...
            <p className="text-neutral-500 mt-12">
              ...
              <span
                ...
                className="text-while ml-1 hover:underline cursor-pointer"
              >
